...
$k=\frac{2\pi}{\lambda}=\frac{2\pi}{Wellenlänge}$\\
...
\textbf{Voraussetzung}\\
$|\vec{x_n}-\vec{y}|$ sind alle ähnlich zueinander $\Rightarrow$ FernFeld
\end{minipage}
...
Loops, welche einen Teil der Energie von der Mainkäule verbraucht\\
...
Falls Niques Theorem nicht erfüllt wird:
