...
\textbf{Standardmässig} verwenden wir $base=2$, also bit oder gekürzt \textbf{b}. Binary Unit ist
...
\begin{minipage}{9.5cm}
	\begin{center}
		\includegraphics[width=8cm]{bilder/10_DMC.png}
	\end{center}
\end{minipage}
...
\begin{minipage}{4cm}
\begin{center}
	\includegraphics[height=3cm]{bilder/10_channels_lossless.png}
\end{center}
\end{minipage}
...
\begin{minipage}{4cm}
\begin{center}
	\includegraphics[height=3cm]{bilder/10_channels_deterministic.png}
\end{center}
\end{minipage}
...
\begin{minipage}{4cm}
\begin{center}
	\includegraphics[width=4.5cm]{bilder/10_channels_noiseless.png}
\end{center}
\end{minipage}
...
\begin{minipage}{4cm}
\begin{center}
	\includegraphics[width=4.5cm]{bilder/10_channels_binarysymmetrical.png}
\end{center}
\end{minipage}
...
\skriptsubsection{Hilbert Transform}{36}
  90° Phase shift:
  $$\hat{s}(t) = s(t) * \left(\frac{1}{\pi t}\right) \FT \hat{S}(f) = -j \sign(f)$$
  Example with sine/cosine:
  $$\mathcal{H}\left\{(A(t) \sin(2 \pi f + \varphi(t))\right\} = A(t) \cos(2 \pi f + \varphi(t)) \qquad \qquad 
  \mathcal{H}\left\{A(t) \cos(2 \pi f + \varphi(t))\right\} = A(t) \sin(2 \pi f + \varphi(t))$$
